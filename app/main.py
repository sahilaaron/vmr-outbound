...
from app.db.session import create_db_engine, engine
...
def create_app(
    ...
    if readiness_probe is None:
        ...
        if settings.database_url != configured_settings.database_url:
            owned_readiness_engine = create_db_engine(
                settings.database_url,
                connect_timeout_seconds=settings.database_connect_timeout_seconds,
            )
            readiness_engine = owned_readiness_engine
        readiness_probe = DatabaseReadinessProbe(
            readiness_engine, timeout_seconds=settings.readiness_timeout_seconds
        )
