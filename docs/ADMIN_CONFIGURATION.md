...
| --- | --- |
| Company research | — |
| Claude Research availability (legacy `research_claude_fallback` key) | Claude CLI command; Company research. Off blocks Research and never restores deterministic crawling. |
